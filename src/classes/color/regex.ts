...
let rgbRegex: RegExp | undefined;
let rgbaRegex: RegExp | undefined;
let hslRegex: RegExp | undefined;
let hslaRegex: RegExp | undefined;
let hexRegex: RegExp | undefined;
let namedRegex: RegExp | undefined;
let anyStrictRegex: RegExp | undefined;
...
export const colorRegex = {
	 ...
	 */
	get named(): RegExp {
		namedRegex ??= new RegExp(`^(${namedColors})$`);
		return namedRegex;
	},
	/**
	 * Regular expression to match any color
	 * @type {RegExp}
	 */
	get anyStrict(): RegExp {
		anyStrictRegex ??= new RegExp(
			`^(${namedColors}|${RGB}|${RGBA}|${HSL}|${HSLA}|${HEX})$`,
			"i",
		);
		return anyStrictRegex;
	},
	/**
	 * Regular expression to match any color
